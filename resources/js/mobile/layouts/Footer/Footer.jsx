    ...
    <>
      ...
      <footer>
        ...
        <div className="py-5 container mx-auto">
            ...
            {items.map((item, index) => (
              <li key={index}>
                ...
                <button
                  ...
                  className="w-full py-2 text-left focus:outline-none flex justify-between items-center"
                >
          ...
          <div className="pt-16 pb-2 text-sm text-center flex flex-col gap-2 text-primary-300 font-semibold">
            <div>
