  ...
  return (
    <section className="py-16">
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-5 grid-cols-2 gap-3 mb-5 p-3">
          {sales?.map((sale, index) => (
            <div key={index} className="bg-yellow-100 p-3 rounded-lg">
              ...
              <div className="flex gap-2 items-center">
                ...
                <div className="text-sm">{sale.reviews} Reviews</div>
              </div>
              <div className="flex items-center gap-3 py-3">
                <del className="text-gray-400">₹{sale.regularPrice}</del>
