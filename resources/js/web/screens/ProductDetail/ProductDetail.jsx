...
import { FaHeartCirclePlus, FaThumbsUp } from "react-icons/fa6";
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-5 gap-5">
          ...
          <div className="col-span-2">
            <h1 className="text-primary-300 text-5xl font-semibold">
              Transbond MultiFill
            </h1>
            ...
            <div className="grid grid-cols-8 [&>div>img]:size-14 [&>div>img]:inline my-10 text-center uppercase text-[10px] leading-[100%] text-primary-300 font-bold">
              <div>
                <img src="/images/product-attributes/1.png" alt="" />
                <div className="mt-1">More Coverage</div>
              </div>
              <div>
            ...
            <div className="flex items-center gap-5 uppercase font-bold text-primary-300 text-center text-xs my-10">
              ...
              <div>
                <img src="/images/wood.png" alt="" className="h-10 inline" />
                <div>Wood</div>
              </div>
              <div>
            ...
            <div className="text-primary-300 font-bold uppercase">
              <div className="mb-2 text-sm">
                Packaging Size: {sizes[activeSize].name}
              </div>
              ...
              <div className="ms-auto">
                ...
                <div className="flex bg-pink-300 gap-2 items-center text-white px-3 py-1 rounded">
                  ...
                  <div className="font-bold text-xl">
                    <span className="text-sm">₹</span>800
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-2 uppercase">
              ...
              <button
                type="button"
                className="bg-secondary text-primary-300 hover:bg-primary-300 hover:text-white grow rounded-lg font-bold text-3xl"
              >
                Add To Cart
              </button>
              <button className="bg-orange-400 px-5 rounded-lg text-white text-3xl font-bold">
                Buy Now
              </button>
            </div>
          </div>
        ...
        <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-12 gap-5">
              <div className="col-span-3 text-primary-300">
              ...
              <div className="col-span-9 border-s-2 ps-5">
                <div className="border-b text-primary-300">
                  <div className="grid grid-cols-12">
                    <div className="flex col-span-8 gap-5">
                      <div className="text-2xl font-bold pb-2 border-b-4 border-primary-300">
                        Reviews (367)
                      </div>
                      <div className="text-2xl  pb-2">Questions (74)</div>
                    </div>
                    <div className="col-span-4">
                      <h3 className="text-2xl font-bold pb-2">Sort</h3>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-12 items-center">
                    <div className="col-span-8">
                      <div className="flex items-center gap-1 py-5">
                        <button
                          type="button"
                          className="bg-primary-300 text-white flex items-center gap-2 px-3 py-2 rounded-lg text-lg font-bold hover:bg-primary-600 me-3"
                        >
                          <BiFilter size={30} /> Filters
                        </button>

                        <button
                          type="button"
                          className="bg-gray-200 py-2 px-5 rounded-full text-orange-400"
                        >
                          <BiSolidStar size={15} />
                        </button>
                        ...
                        <button
                          type="button"
                          className="bg-gray-200 py-2 px-5 rounded-full text-orange-400 flex items-center"
                        >
                          <BiSolidStar size={15} />
                          <BiSolidStar size={15} />
                        </button>
